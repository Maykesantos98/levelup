...
const allPlayers = [
  { id: 1, name: "Arthur Márcio", avatar: "A", xp: 600, level: 3, color: "from-orange-500 to-yellow-500" },
  {
    id: 2,
    name: "Mayke Costa santos",
    avatar: "M",
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-card border-2 border-border rounded-3xl p-8">
            <div className="flex flex-col items-center">
              ...
              <div
                className={`w-24 h-24 bg-gradient-to-br ${topPlayers[1].color} rounded-full flex items-center justify-center mb-4`}
              >
              ...
              <p className="text-4xl font-bold text-yellow-500 mb-1">{topPlayers[1].xp} XP</p>
              <p className="text-sm text-muted-foreground">Nível {topPlayers[1].level}</p>
            </div>
          </div>

          {/* First Place - Featured */}
          <div className="bg-gradient-to-br from-yellow-600/20 to-orange-600/20 border-2 border-yellow-500 rounded-3xl p-8">
            <div className="flex flex-col items-center">
              <Crown className="w-12 h-12 text-yellow-400 mb-4" />
              <div
                className={`w-28 h-28 bg-gradient-to-br ${topPlayers[0].color} rounded-full flex items-center justify-center mb-4 ring-4 ring-yellow-500/30`}
              >
        ...
        <div>
          ...
          <div className="space-y-3">
            {allPlayers.map((player, index) => (
              <div
                key={player.id}
                className={`bg-card border rounded-2xl p-6 flex items-center gap-6 ${
                  player.current ? "border-primary ring-2 ring-primary/20" : "border-border"
                }`}
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${player.color} rounded-full flex items-center justify-center`}
                  >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      ...
                      {player.current && (
                        <span className="text-xs bg-primary/20 text-primary px-2 py-1 rounded-full">Você</span>
                      )}
                    </div>
