          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <div className="bg-card border border-border rounded-2xl rounded-tl-none p-4">
                ...
                <p className="mb-3">
                  Se você tiver alguma dúvida sobre as missões ou precisar de dicas de estudo, é só me avisar!
                  Lembre-se, cada pequeno passo conta e você está apenas começando. Vamos juntos conquistar seus
                  objetivos! 🚀
                </p>
